...
const resInputs = {
  ...
  managementPct: 10, maintenancePct: 1, capExPct: 5, holdYears: 5, appreciationPct: 3,
};
...
const comInputs = {
  ...
  vacancyPct: 5, creditLossPct: 1, opexAnnual: 96000, goingInCapRate: 6, exitCapRate: 6.5,
  maxLTV: 75, minDSCR: 1.25, minDebtYield: 8, interestRate: 7, amortYears: 25,
...
describe('validateEngineInput', () => {
  ...
  it('reports field errors for invalid input', () => {
    const v = validateEngineInput('residential', { ...resInputs, purchasePrice: 0 });
