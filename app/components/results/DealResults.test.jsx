...
const results = {
  ...
  irr: 11.5, equityMultiple: 1.8, dscr: 1.3, debtYield: 9.5, exitValue: 410000,
  redFlags: [],
};

const commercialResults = {
  mode: 'commercial', assetType: 'multifamily',
  investmentGrade: 'B', investmentScore: 70,
  noi: 120000, goingInCap: 6, exitCapRate: 6.5, oer: 40,
  pricePerUnit: 250000, pricePerSF: 166, value: 2000000,
  maxLoan: 1400000, bindingConstraint: 'DSCR', equity: 600000,
  dscr: 1.3, debtYield: 9, annualDebtService: 90000,
  leveredIRR: 12.4, unleveredIRR: 7.8, equityMultiple: 1.9,
  cashOnCash: 8, leverageAccretive: true, breakEvenOccupancy: 80,
  monthlyCashFlow: 2500, redFlags: [],
};
