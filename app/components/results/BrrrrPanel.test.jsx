...
const infiniteInputs = {
  purchasePrice: 100000, rehabBudget: 30000, arv: 200000,
  refiLtv: 75, refiRate: 7, closingCostsBuyPct: 3,
  monthlyRent: 1800, vacancyPct: 5, managementPct: 8,
  maintenancePct: 1, capExPct: 5, annualPropertyTax: 1500, annualInsurance: 900,
};
...
describe('BrrrrPanel', () => {
  it('surfaces the infinite-return flag for a known fixture', () => {
    ...
    render(<BrrrrPanel inputs={infiniteInputs} results={results} onChange={vi.fn()} />);
  ...
  it('shows cash-left-in-deal and post-refi cash flow metrics', () => {
    ...
    expect(screen.getAllByText(/post-refi cash flow/i).length).toBeGreaterThan(0);
  });
});
