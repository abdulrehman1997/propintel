...
export const ResidentialInputs = ({
  inputs,
  results,
  onChange,
  errors = {},
    ...
    <div className="space-y-4">
      <Card title="Property & Purchase" icon={Home} defaultOpen>
        <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    inputCls,
                    "pl-7",
                    errors.purchasePrice && "border-rose-400",
                  )}
                />
              </div>
          ...
          <div className="col-span-2">
            <InputGroup
              label={`Down Payment: ${inputs.downPaymentPct}% (${formatCurrency(results?.downPaymentDollar ?? 0)})`}
            >
              <input
                type="range"
                min="0"
            ...
            <div className="relative">
              <input
                ...
                className={cn(
                  inputCls,
                  "pr-7",
                  errors.interestRate && "border-rose-400",
                )}
              />
          ...
          <InputGroup label="Monthly Rent">
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  inputCls,
                  "pl-7 text-lg font-bold",
                  errors.monthlyRent && "border-rose-400",
                )}
              />
            </div>
      ...
      <Card title="Projection & Exit" icon={TrendingUp}>
        <div className="grid grid-cols-2 gap-4">
          ...
          <InputGroup
            label={`Appreciation: ${inputs.appreciationPct ?? 3}%`}
            tooltip="Annual property value growth — was previously hardcoded."
          >
            <input
              type="range"
              min="0"
          ...
          <InputGroup
            label={`Expense Growth: ${inputs.expenseGrowthPct ?? 3}%`}
          >
            <input
              type="range"
              min="0"
          ...
          <InputGroup
            label="Exit Cap Rate"
            tooltip="Terminal value = forward NOI ÷ exit cap. Leave 0 to use appreciated value."
          >
            <div className="relative">
              <input
                type="number"
          ...
          <InputGroup
            label="Sale Cost %"
            tooltip="Selling costs deducted from terminal value."
          >
            <div className="relative">
              <input
                type="number"
