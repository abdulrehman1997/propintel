...
const STRESS_SCENARIOS = [
  { scenario: 'rent-5',         shocks: { rentMult: 0.95, vacancyAdd: 0,    opexMult: 1,    rateAdd: 0,    exitCapAdd: 0 } },
  { scenario: 'rent-10',        shocks: { rentMult: 0.90, vacancyAdd: 0,    opexMult: 1,    rateAdd: 0,    exitCapAdd: 0 } },
  { scenario: 'vacancy+5',      shocks: { rentMult: 1,    vacancyAdd: 0.05, opexMult: 1,    rateAdd: 0,    exitCapAdd: 0 } },
  { scenario: 'opex+10',        shocks: { rentMult: 1,    vacancyAdd: 0,    opexMult: 1.10, rateAdd: 0,    exitCapAdd: 0 } },
  { scenario: 'opex+20',        shocks: { rentMult: 1,    vacancyAdd: 0,    opexMult: 1.20, rateAdd: 0,    exitCapAdd: 0 } },
  { scenario: 'rate+100bps',    shocks: { rentMult: 1,    vacancyAdd: 0,    opexMult: 1,    rateAdd: 0.01, exitCapAdd: 0 } },
  { scenario: 'rate+200bps',    shocks: { rentMult: 1,    vacancyAdd: 0,    opexMult: 1,    rateAdd: 0.02, exitCapAdd: 0 } },
  { scenario: 'exitCap+50bps',  shocks: { rentMult: 1,    vacancyAdd: 0,    opexMult: 1,    rateAdd: 0,    exitCapAdd: 0.005 } },
  { scenario: 'exitCap+100bps', shocks: { rentMult: 1,    vacancyAdd: 0,    opexMult: 1,    rateAdd: 0,    exitCapAdd: 0.010 } },
  { scenario: 'combined-bad-case', shocks: { rentMult: 0.95, vacancyAdd: 0.05, opexMult: 1.10, rateAdd: 0.01, exitCapAdd: 0.005 } },
];
